...
describe(
  ...
  () => {
    ...
    it(
      'should load study areas on initialization',
      () => {
    ...
    it(
      'should start creating a new study area',
      () => {
        component.editingId =
          'study-area-1';
    ...
    it(
      'should populate the form when editing',
      () => {
        component.startEdit(
          studyAreas[0]
        );
    ...
    it(
      'should validate empty weekly goal',
      () => {
        component.name =
          'Matemática';
    ...
    it(
      'should validate positive integer weekly goal',
      () => {
        component.name =
          'Matemática';
    ...
    it(
      'should validate non-integer weekly goal',
      () => {
        component.name =
          'Matemática';
    ...
    it(
      'should create a study area through the service',
      () => {
        component.name =
          'Matemática';
    ...
    it(
      'should trim the study area name before creating',
      () => {
        component.name =
          '  Matemática  ';
    ...
    it(
      'should update an existing study area through the service',
      () => {
        component.editingId =
          'study-area-1';
    ...
    it(
      'should delete a study area after confirmation',
      () => {
        spyOn(
          window,
          'confirm'
    ...
    it(
      'should not delete when confirmation is cancelled',
      () => {
        spyOn(
          window,
          'confirm'
    ...
    it(
      'should handle create validation errors from the backend',
      () => {
        studyAreaService.create.and.returnValue(
          throwError(
            () =>
    ...
    it(
      'should handle update not found errors',
      () => {
        studyAreaService.update.and.returnValue(
          throwError(
            () =>
    ...
    it(
      'should handle delete not found errors',
      () => {
        spyOn(
          window,
          'confirm'
    ...
    it(
      'should emit closed when closing',
      () => {
        const emitSpy =
          spyOn(
            component.closed,
    ...
    it(
      'should not close while deleting',
      () => {
        const emitSpy =
          spyOn(
            component.closed,
    ...
    it(
      'should track study areas by id',
      () => {
        expect(
