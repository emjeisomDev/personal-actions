...
describe('WeeklyAssessmentRepository', () => {
    const assessmentRow = {
        id: 'assessment-1',
    ...
    describe('findById', () => {
        it('deve retornar a avaliação mapeada', async () => {
            const {
                database,
                query
        ...
        it('deve retornar null quando a avaliação não existir', async () => {
            const {
                database,
                query
            } = createDatabaseExecutorMock();
    ...
    describe('findByStudyAreaWeekId', () => {
        it('deve retornar a avaliação da semana', async () => {
            const {
                database,
                query
            } = createDatabaseExecutorMock();
        ...
        it('deve retornar null quando não houver avaliação', async () => {
            const {
                database,
                query
            } = createDatabaseExecutorMock();
    ...
    describe('create', () => {
        it('deve criar uma avaliação semanal', async () => {
            const {
                database,
                query
            } = createDatabaseExecutorMock();
